error id: file:///D:/devops-classroom-main-postgresql-fixed/devops-classroom-main/backend/src/main/java/com/devopsclassroom/service/MensagemService.java:java/lang/Long#
...
public class MensagemService {
    ...
    public List<Mensagem> listarMensagensDaAula(Long@@ aulaId) {
        return mensagemRepository.findByAulaIdOrderByCriadoEmAsc(LongaulaId);
    }
}
